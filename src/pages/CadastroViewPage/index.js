    ...
    <Layout style={style}>
      ...
      <Content style={{ margin: '24px 16px 0' }}>
        <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
            <div id="cabecario">
                <h1>Vizualizar Dados do Membro</h1>
                <p>Selecione um membro para visualizar:</p>
            </div>
            <br/>
            <div style={{display: 'flex', flexDirection: 'column', gap: '20px'}}>
              <Statistic title="Membros Cadastrados" value={data.length} />
              <Divider />
              {data.length > 0 
              ? (<Table 
                rowSelection={{
...
export default CadastroViewPage;